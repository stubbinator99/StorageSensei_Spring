...
import com.storagesensei.models.ListType;
...
public interface ListRepository extends JpaRepository<UserList, Long> {
  ...
  @Query(value = "SELECT l FROM lists WHERE l.owner=?1 AND l.list_id = ?2", nativeQuery = true)
  public UserList findListByIdAndUser(String username,long listId);
